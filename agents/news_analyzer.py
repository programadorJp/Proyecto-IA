"""news_analyzer.py — Análisis Avanzado de Noticias
...
class NewsAnalyzer:
    ...
    # Base de datos de noticias actualizada (simulación)
    NOTICIAS_DETALLADAS = {
        'ALICORC1.LM': [
            {
