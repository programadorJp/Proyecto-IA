"""conversational_response.py — Generador de Respuestas Conversacionales (con esteroides)
...
class ConversationalResponseGenerator:
    ...
    def generar_analisis_conversacional(self, ticker: str, empresa: str, datos_completos: dict) -> str:
        """
...
"""
    ...
    def _generar_bienvenida(self, empresa: str, ticker: str) -> str:
        """Genera bienvenida conversacional."""
        return f"Hola, te presento mi análisis detallado de {empresa} ({ticker}).\n\nAquí lo que veo en el mercado ahora mismo:"

    def _generar_resumen_actual(self, empresa: str, recomendacion: dict, noticias: dict) -> str:
...
Esto es importante porque refuerza o contradice lo que vemos en los números."""
    ...
    def _generar_seccion_noticias(self, empresa: str, noticias: dict) -> str:
...
positivas, probablemente el precio subirá en el futuro."""
    ...
    def _generar_seccion_catalistas(self, empresa: str, catalistas: dict) -> str:
    ...
    def _generar_seccion_predicciones(self, empresa: str, predicciones: dict) -> str:
...
"""
    ...
    def _generar_recomendacion_final(self, empresa: str, recomendacion: dict, predicciones: dict) -> str:
...
"""
    ...
    def generar_respuesta_rapida(self, ticker: str, empresa: str, score_final: float, recomendacion: str) -> str:
